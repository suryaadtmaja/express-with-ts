...
var PostService = /** @class */ (function () {
    function PostService() {
        ...
        this.create = function (post) { return __awaiter(_this, void 0, void 0, function () {
            var newPost;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.postRepository.save(post)];
                    case 1:
                        newPost = _a.sent();
        ...
        this.postRepository =
            typeorm_1.getConnection("blog").getCustomRepository(post_repository_1.PostRepository);
    }
    return PostService;
}());
